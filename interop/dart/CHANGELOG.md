...
- Aligns the Dart protocol package with the preview.8 compatibility line.
...
- Aligns the Dart protocol package version with the Dihor.GameKit.Networking preview.4 release line.
- Keeps the protocol-v2 envelope, connection descriptor and canonical fixture contract unchanged.
...
- Aligns the Dart protocol package version with the Dihor.GameKit.Networking preview.3 release line.
- Keeps the protocol-v2 envelope, connection descriptor and canonical fixture contract unchanged.
...
- Aligns the Dart protocol package version with the Dihor.GameKit.Networking preview.2 release line.
...
- Moves Dart interoperability to Dihor.GameKit.Networking protocol v2.
...
- Adds Dihor.GameKit.Networking protocol v1 envelope parsing.
