...
- Keeps protocol v2 wire identifiers stable, including the legacy `partygamekit://connect` URI scheme and existing SignalR/WebRTC method names, so the repository rename does not silently break protocol-v2 interoperability.
