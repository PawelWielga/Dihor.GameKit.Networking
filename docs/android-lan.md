...
Dihor.GameKit.Networking `0.2.0-preview.7` supports the direct LAN WebSocket path from `net10.0-android` applications without requiring the `Microsoft.AspNetCore.App` runtime pack.
