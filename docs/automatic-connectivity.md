...
The browser SDK exposes the same orchestration policy as a generic selector. Candidates can wrap `GameKitNetworkingClient`, `WebRtcPeer`, SignalR relay integration or another communication adapter without teaching the selector product semantics.
