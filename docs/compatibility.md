...
| Dart runtime | `dihor_gamekit_networking` `0.2.0-preview.6` | 2 | Dart VM / Flutter mobile and desktop | direct LAN WebSocket client, connect/resume continuity, heartbeat, explicit disconnect, bounded/cancellable reconnect and opaque application-message send/receive; discovery/automatic selection/timing follow in later issues |
